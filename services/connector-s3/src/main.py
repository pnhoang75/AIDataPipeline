...
def main() -> None:
    ...
    logger.info("Starting S3 connector", connector_id=config.connector_id)
    ...
    connector = S3Connector(minio_client, kafka_producer, redis_client, db_conn)
